...
import {
  ...
  platformStorageAnalyticsController,
...
adminRouter.put("/settings", async (request, response) => {
  try {
    const allowed = [
      "platformName", "platformLogo", "companyName", "supportEmail", "supportPhone",
      "currencyCode", "currencySymbol", "currencyPosition", "platformFeePercent",
      "trialEnabled", "trialDays", "defaultPlanSlug", "maintenanceMode",
      "vatPercent", "taxPercent", "invoicePrefix", "invoiceLogo",
      "enabledDurations", "enabledPaymentMethods",
...
// ── Storage Management ───────────────────────────────────────────
adminRouter.get("/storage/analytics", platformStorageAnalyticsController);
adminRouter.get("/storage/stores", platformStoreStorageListController);
adminRouter.put("/storage/stores/:storeId", updateStoreStorageController);
