      ...
      <div className={landingContainer}>
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 mb-14">
          ...
          <p className="text-base sm:text-lg text-zinc-600 leading-relaxed font-normal">
            Drag, drop, customize, and publish. A visual layout editor that generates responsive, high-converting storefronts automatically.
          </p>
        </div>

        {/* Big 3-Pane Studio Container */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 min-h-[420px]">
            ...
            <div className="hidden md:block md:col-span-3 border-r border-zinc-800 p-5 bg-zinc-950/60 space-y-4 text-xs">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { name: "Footer & Social Links", active: true },
                ].map((s, i) => (
                  <div
                    key={i}
            ...
            <div className="hidden md:block md:col-span-3 border-l border-zinc-800 p-5 bg-zinc-950/60 space-y-4 text-xs">
              ...
              <div className="space-y-3.5 text-[11px]">
                <div>
                  <label className="text-zinc-400 block mb-1.5">Store Brand Accent</label>
                  <div className="flex items-center gap-2">
                ...
                <div>
                  <label className="text-zinc-400 block mb-1.5">Grid Columns</label>
