        ...
        <div className="max-w-7xl mx-auto w-full min-w-0 px-4 sm:px-6 lg:px-8 flex items-center gap-3 min-w-0">
          ...
          >
            <button
              ...
              className="flex items-center gap-2.5 px-5 py-2.5 bg-[var(--store-primary,#e05a00)] text-white font-semibold text-xs rounded-t-lg transition-colors hover:bg-[var(--store-primary,#c2410c)]"
            >
          ...
          <div className="flex items-center gap-3 min-w-0 flex-1 overflow-hidden">
            <Link
              href="/"
              className={cn(
                "shrink-0 py-2.5 text-xs font-semibold text-zinc-700 hover:text-[var(--store-primary,#e05a00)] transition-colors",
                pathname === "/" && "text-[var(--store-primary,#e05a00)]",
              )}
            >
              {t("home", storeLang)}
            </Link>
            <Link
              ...
              className={cn(
                "shrink-0 py-2.5 text-xs font-semibold text-zinc-700 hover:text-[var(--store-primary,#e05a00)] transition-colors",
                pathname === "/shop" && "text-[var(--store-primary,#e05a00)]",
              )}
            >
              {t("shop", storeLang)}
            </Link>
            ...
            <Link
              href="/offers"
              className="shrink-0 flex items-center gap-1 py-2.5 text-xs font-semibold text-[var(--store-primary,#e05a00)] hover:text-[var(--store-primary,#c2410c)] transition-colors"
            >
          ...
          <Link
            href="/branches"
            className="shrink-0 flex items-center gap-1 text-xs font-semibold text-[var(--store-secondary,#055c3a)] hover:text-[var(--store-primary,#e05a00)] transition-colors"
          >
          ...
          <div className="w-4/5 max-w-sm bg-white h-full overflow-y-auto p-4 flex flex-col justify-between shadow-2xl animate-in slide-in-from-left duration-200">
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-zinc-100">
                <span className="font-bold text-base text-[var(--store-secondary,#055c3a)]">{storeName}</span>
                <button
                  type="button"
                    ...
                    <div key={cat._id} className="border-b border-zinc-50 pb-1">
                      <div className="flex items-center justify-between px-2 py-2 rounded-lg hover:bg-zinc-50">
                        <Link
                          ...
                          onClick={() => setMobileMenuOpen(false)}
                          className="font-semibold text-xs text-zinc-800 hover:text-[var(--store-secondary,#055c3a)] flex-1 truncate"
                        >
                        ...
                        <div className="pl-4 pr-2 py-1.5 space-y-1 bg-zinc-50/60 rounded-lg">
                          {subs.map((sub) => (
                            <Link
                              ...
                              onClick={() => setMobileMenuOpen(false)}
                              className="flex items-center justify-between py-1 px-2 text-xs text-zinc-600 hover:text-[var(--store-secondary,#055c3a)]"
                            >
              ...
              <div className="py-2 border-t border-zinc-100 space-y-1">
                ...
                <Link href="/offers" onClick={() => setMobileMenuOpen(false)} className="block px-3 py-2 text-xs font-semibold text-[var(--store-primary,#e05a00)]">
                  {t("offers", storeLang)}
                </Link>
