...
export default function TrafficSourcesPage() {
  ...
  if (!storeId) {
    return <div className="flex h-[60vh] items-center justify-center"><p className="text-zinc-500">Create a store to view traffic sources.</p></div>;
  }

  if (isLoading) {
    return <div className="flex justify-center py-24"><Loader2 className="h-6 w-6 animate-spin text-zinc-400" /></div>;
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
          ...
          <p className="mt-1 text-2xl font-bold text-zinc-900">{totalVisits}</p>
        </motion.div>
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}
          className="rounded-xl border border-zinc-200 bg-white p-4">
          <p className="text-xs font-medium text-zinc-500">Traffic Sources</p>
          <p className="mt-1 text-2xl font-bold text-zinc-900">{sources.length}</p>
        </motion.div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1.5fr]">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <h3 className="mb-3 text-sm font-semibold text-zinc-900">Distribution</h3>
          <div className="h-64">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
          className="rounded-xl border border-zinc-200 bg-white p-5">
          <h3 className="mb-3 text-sm font-semibold text-zinc-900">Top Landing Pages</h3>
