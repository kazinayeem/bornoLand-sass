    ...
    <StorePageCard>
      <div className="space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-zinc-900">Pages</h2>
            <p className="mt-1 text-sm text-zinc-500">Manage storefront pages and open them in the builder.</p>
          </div>
          <button
            type="button"
            disabled={creating}
