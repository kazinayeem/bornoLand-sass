...
import { Smartphone, ShoppingBag, BarChart3, MessageSquare, Package, Bell, ArrowRight } from "lucide-react";
  ...
  return (
    <section className="relative px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-b from-indigo-500/5 to-transparent blur-3xl" />
      </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1.2fr]">
          ...
          >
            ...
            <div className="mt-6 space-y-3">
              {features.map((f) => (
                <div key={f.title} className="flex items-center gap-3 rounded-xl border border-zinc-100 bg-white p-3.5 shadow-sm">
                  ...
                  <span className="text-sm font-medium text-zinc-700">{f.title}</span>
                </div>
              ))}
            </div>

            <div className="mt-6 flex flex-wrap gap-3">
              <span className="inline-flex items-center gap-2 rounded-xl bg-zinc-900 px-4 py-2.5 text-xs font-semibold text-white shadow-md">
                <Smartphone className="h-4 w-4" /> Google Play
              </span>
              <span className="inline-flex items-center gap-2 rounded-xl border border-zinc-200 bg-white px-4 py-2.5 text-xs font-semibold text-zinc-700 shadow-sm">
          ...
          >
            <div className="mx-auto max-w-[280px]">
              {/* Phone Frame */}
              <div className="overflow-hidden rounded-[2.5rem] border-[3px] border-zinc-200 bg-white shadow-xl">
                <div className="bg-gradient-to-b from-blue-600 to-indigo-600 p-4 text-white">
                ...
                <div className="p-4 space-y-3">
                  {[
                    ...
                    <div key={item.label} className="flex items-center justify-between rounded-xl bg-zinc-50 px-3.5 py-3">
