...
export default function LiveVisitorsPage() {
  ...
  if (!selectedStore) {
    return (
      <div className="flex h-[60vh] items-center justify-center">
        <p className="text-apple-ink-muted-48">Create a store to view live visitors.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        <div className="flex justify-center py-24"><Loader2 className="h-6 w-6 animate-spin text-apple-ink-muted-48" /></div>
      ) : count === 0 ? (
                    ...
                    return (
                      <div key={d.name}>
                        <div className="flex items-center justify-between text-xs">
                          <span className="text-apple-ink-muted-80">{d.name}</span>
