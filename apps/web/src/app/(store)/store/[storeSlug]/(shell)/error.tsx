...
import { AlertCircle, RefreshCw, LayoutDashboard, Store, Sparkles } from "lucide-react";
...
export default function StoreShellError({
  ...
  useEffect(() => {
    ...
    if (isChunkLoadError(error)) {
      ...
      // Attempt automatic 1-time page reload
      attemptChunkReload();
    }
  }, [error]);
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-12 text-center">
        ...
        <p className="mt-1.5 text-xs text-zinc-500 max-w-md dark:text-zinc-400">
          A new version of BornoLand has been deployed. Please reload the page to load the latest features and updates.
        </p>
