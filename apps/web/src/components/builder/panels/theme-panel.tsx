    ...
    <div className="h-full space-y-5 overflow-y-auto overscroll-contain p-3">
      <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-3">
        <div className="mb-2 flex items-center gap-1.5">
          <Palette className="h-3.5 w-3.5 text-[#e05a00]" />
          <p className="text-[11px] font-semibold uppercase tracking-wider text-apple-ink-muted-48">
            Store Theme
          </p>
        </div>
        <p className="mb-3 text-[11px] leading-relaxed text-zinc-500">
          Switch platform themes (Grocery, Electronics, etc.) from Design. That flow saves your active theme,
          default sections, and store data — then opens the builder.
        </p>
        <Link
          href={`/store/${storeSlug}/design`}
          className="inline-flex items-center gap-1.5 rounded-lg border border-zinc-300 bg-white px-3 py-2 text-xs font-semibold text-zinc-800 transition-colors hover:bg-zinc-100"
        >
          Open Design Themes
