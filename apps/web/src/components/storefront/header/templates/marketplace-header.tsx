...
export function MarketplaceHeader({ headerSettings = {} }: MarketplaceHeaderProps) {
  ...
  return (
    <header className="w-full bg-white text-zinc-900 border-b border-zinc-200 shadow-sm select-none relative z-40">
      ...
      {/* ── Second Navigation Row with All Categories Mega Button ── */}
      <div className="hidden md:block bg-zinc-50 border-t border-zinc-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 text-xs font-semibold text-zinc-700">
            <Link href="/shop" className={cn("py-2.5 hover:text-[#f85606] transition-colors", pathname === "/shop" && "text-[#f85606]")}>
              {t("shop", storeLang)}
            </Link>
            <Link href="/offers" className="flex items-center gap-1 py-2.5 text-[#f85606] hover:text-[#e04800] transition-colors">
              <Flame className="w-3.5 h-3.5" />
              <span>Flash Sale</span>
            </Link>
            <Link href="/new-arrivals" className="flex items-center gap-1 py-2.5 hover:text-[#f85606] transition-colors">
              <Sparkles className="w-3.5 h-3.5 text-amber-500" />
              <span>New Arrivals</span>
            </Link>
            <Link href="/brands" className="py-2.5 hover:text-[#f85606] transition-colors">
              {t("brands", storeLang)}
            </Link>
            <Link href="/best-sellers" className="flex items-center gap-1 py-2.5 hover:text-[#f85606] transition-colors">
              <TrendingUp className="w-3.5 h-3.5 text-emerald-600" />
              <span>Best Sellers</span>
            </Link>
          </nav>

          <Link href="/track-order" className="text-xs font-semibold text-zinc-600 hover:text-[#f85606] transition-colors">
            Track Order
          </Link>
        </div>
      </div>
