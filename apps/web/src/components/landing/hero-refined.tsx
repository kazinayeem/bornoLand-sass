    ...
    <section className="relative overflow-hidden pt-28 pb-16 sm:pt-36 sm:pb-24 bg-[radial-gradient(ellipse_80%_60%_at_50%_-20%,rgba(37,99,235,0.08),rgba(255,255,255,0))]">
      <div className={landingContainer}>
        ...
        <div className="flex justify-center mb-6">
          <LiveIndicator
            label="THE COMMERCE OPERATING SYSTEM"
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-base sm:text-lg text-zinc-600 leading-relaxed font-normal">
            Launch a high-converting storefront, manage multi-store inventory, accept bKash and COD, print automated invoices, and scale your brand without technical complexity.
          </p>

          <p className="text-xs font-semibold uppercase tracking-wider text-blue-600">
            Built for modern ecommerce businesses.
          </p>
        ...
        {/* ONE Large Realistic Product Dashboard with Floating Pills */}
