  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-5">
        <h4 className="text-sm font-semibold text-apple-ink-muted-80">Current Usage</h4>
        <div className="mt-4">
          ...
          <p className="mt-1 text-right text-xs text-apple-ink-muted-48">
        ...
        {usage && (
          <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
            <div className="rounded-lg bg-apple-canvas-parchment p-3">
              <p className="text-xs text-apple-ink-muted-48">Plan Limit</p>
              <p className="font-semibold text-zinc-800">{planLimitMB} MB</p>
            </div>
            <div className="rounded-lg bg-apple-canvas-parchment p-3">
              <p className="text-xs text-apple-ink-muted-48">Override</p>
      ...
      {/* Override controls */}
      <div className="rounded-xl border border-zinc-200 bg-white p-5">
        <h4 className="text-sm font-semibold text-apple-ink-muted-80">Storage Override</h4>
        ...
        <div className="mt-4 space-y-4">
          <label className="flex items-center gap-3">
            ...
            />
            <span className="text-sm text-apple-ink-muted-80">Unlimited storage</span>
          </label>

          {!localStorageUnlimited && (
            <div>
              <label className="mb-1 block text-sm font-medium text-apple-ink-muted-80">
      ...
      {/* Quick actions */}
      <div className="rounded-xl border border-zinc-200 bg-white p-5">
        <h4 className="text-sm font-semibold text-apple-ink-muted-80">Quick Actions</h4>
