/**
 * Canonical Module Registry & Dependency Definitions for BornoLand SaaS.
 *
 * Single source of truth for:
 * 1. Platform Modules & Categories
 * 2. Module Inter-dependencies
 * 3. Feature & Limit bindings
...
export interface PlatformModuleDefinition {
  ...
  description: string;
  iconName: string;
  dependencies: string[]; // Required prerequisite module keys
...
export const CANONICAL_MODULE_REGISTRY: Record<string, PlatformModuleDefinition> = {
  ...
  pos: {
    ...
    iconName: "Calculator",
    dependencies: ["commerce"], // POS builds upon product catalog and order processing
    status: "active",
  ...
  warehouse: {
    ...
    iconName: "Building2",
    dependencies: ["inventory"], // Warehouse strictly requires Inventory
    status: "active",
...
/**
 * Validate that all module dependencies are satisfied by the enabled module list.
 * Returns { valid: boolean, missingDependencies: Record<string, string[]> }
 */
...
/**
 * Automatically resolve all required prerequisite modules for a selected module set.
 */
