...
export function PricingRedesign() {
  ...
  const PLANS = [
    {
      ...
      priceMonthly: "৳ 0",
      priceYearly: "৳ 0",
      desc: "For new entrepreneurs exploring online retail.",
      badge: null,
    ...
    },
    {
      ...
      priceMonthly: "৳ 2,499",
      priceYearly: "৳ 1,999",
      desc: "Full power for scaling multi-store brands and retail agencies.",
      badge: "MOST POPULAR",
      cta: "Start 7-Day Trial",
      popular: true,
      features: [
    ...
    },
    {
      ...
      priceMonthly: "Custom",
      priceYearly: "Custom",
      desc: "Custom architecture for large multi-brand conglomerates.",
      badge: null,
      cta: "Contact Sales",
      popular: false,
      features: [
  ...
  const COMPARISON_ROWS = [
    ...
    { name: "Developer API & Webhooks", free: "—", starter: "—", biz: "✓", ent: "Dedicated" },
    { name: "Support SLA", free: "Community", starter: "Standard", biz: "Priority 24/7", ent: "Dedicated Mgr" },
  ];

  return (
    <section id="pricing" className="py-20 sm:py-28 bg-white border-b border-zinc-200/80">
      <div className={landingContainer}>
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 mb-12">
          ...
          <p className="text-base sm:text-lg text-zinc-600 leading-relaxed font-normal">
            Start with our 7-day free trial. Scale as your business grows. No hidden transaction percentage fees.
          </p>
