    ...
    return (
      <SectionWrapper section={section}>
        <div className="px-4 sm:px-6 lg:px-8 py-12 text-center">
          <SectionTitle title={p.title || "Testimonials"} subtitle={p.subtitle || ""} textColor={p.textColor} textAlignment={p.textAlignment} />
          <p className="mt-4 text-sm text-zinc-400">No testimonials yet. Add them in the Content tab.</p>
        </div>
      </SectionWrapper>
    );
  }
