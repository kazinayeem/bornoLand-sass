  ...
  return (
    <SectionWrapper section={section} className="min-h-[400px] md:min-h-[560px] flex items-center">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        {p.buttonText && (
          <Link href={p.buttonLink || "#"} className="mt-6 inline-flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-apple-ink hover:bg-apple-canvas-parchment">
            {p.buttonText}
          </Link>
        )}
      </div>
