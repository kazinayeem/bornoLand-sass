...
const TEMPLATE_ALIASES: Record<string, HeaderTemplateId> = {
  ...
  clean: "minimal-clean",
  furniture: "minimal-clean",
  home: "minimal-clean",
  "modern-ecommerce": "modern-ecommerce",
  ecommerce: "modern-ecommerce",
  books: "modern-ecommerce",
  education: "modern-ecommerce",
  kids: "modern-ecommerce",
  baby: "modern-ecommerce",
  ...
  restaurant: "bold-promotional",
  food: "bold-promotional",
  sports: "bold-promotional",
  fitness: "bold-promotional",
...
const FOOTER_ALIASES: Record<string, string> = {
  ...
  restaurant: "classic-ecommerce",
  food: "classic-ecommerce",
  kids: "classic-ecommerce",
  baby: "classic-ecommerce",
  ...
  sports: "modern-multi-column",
  fitness: "modern-multi-column",
  books: "modern-multi-column",
  education: "modern-multi-column",
  minimal: "minimal",
