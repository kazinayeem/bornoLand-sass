  ...
  return (
    <div className="space-y-4 lg:sticky lg:top-24">
      <section className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
        <h3 className="text-xs font-semibold uppercase tracking-wide text-apple-ink-muted-48">Status</h3>
        <select
          value={form.status}
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
        <h3 className="text-xs font-semibold uppercase tracking-wide text-apple-ink-muted-48">Product Type</h3>
        <select
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
        <h3 className="text-xs font-semibold uppercase tracking-wide text-apple-ink-muted-48">Visibility</h3>
        <label className="mt-3 flex items-center gap-2 text-sm text-apple-ink-muted-80">
          <input
            type="checkbox"
      ...
      {product && (
        <section className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-xs font-semibold uppercase tracking-wide text-apple-ink-muted-48">Details</h3>
          <dl className="mt-3 space-y-2 text-xs">
            <div className="flex justify-between gap-2">
              <dt className="text-apple-ink-muted-48">Created</dt>
              <dd className="font-medium text-zinc-800">
                {product.createdAt ? new Date(product.createdAt).toLocaleDateString() : "—"}
              </dd>
            </div>
            <div className="flex justify-between gap-2">
              <dt className="text-apple-ink-muted-48">Updated</dt>
              <dd className="font-medium text-zinc-800">
                {product.updatedAt ? new Date(product.updatedAt).toLocaleDateString() : "—"}
              </dd>
            </div>
            <div className="flex justify-between gap-2">
              <dt className="text-apple-ink-muted-48">Store</dt>
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
        <h3 className="text-xs font-semibold uppercase tracking-wide text-apple-ink-muted-48">Quick Actions</h3>
        <div className="mt-3 space-y-2">
          {previewHref && (
            <a
              href={previewHref}
              target="_blank"
              className="flex w-full items-center gap-2 rounded-xl border border-zinc-200 px-3 py-2 text-sm font-medium text-apple-ink-muted-80 hover:bg-apple-canvas-parchment"
            >
