      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-apple-ink px-4 py-2.5 text-sm font-medium text-white disabled:opacity-50"
          >
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {pages.map((page) => (
              <button
                ...
                type="button"
                onClick={() => openBuilder()}
                className="flex items-start gap-3 rounded-apple-lg border border-apple-hairline bg-white p-4 text-left transition-all hover:border-zinc-300 hover:"
              >
                ...
                <ExternalLink className="mt-1 h-4 w-4 shrink-0 text-apple-ink-muted-48" />
              </button>
            ))}
          </div>
        )}
