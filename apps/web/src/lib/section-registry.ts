...
export const sectionRegistry: SectionDef[] = [
  ...
  },
  {
    ...
    props: merge(
      {
        title: G.text("title", "Section Title", "Our Products"),
        subtitle: G.text("subtitle", "Subtitle", ""),
        gridColumns: G.gridCols(),
        desktopColumns: G.select("desktopColumns", "Desktop Columns", "4", [
          { value: "2", label: "2" },
          { value: "3", label: "3" },
          { value: "4", label: "4" },
          { value: "5", label: "5" },
        ...
        tabletColumns: G.select("tabletColumns", "Tablet Columns", "2", [
          { value: "1", label: "1" },
          { value: "2", label: "2" },
          { value: "3", label: "3" },
        ], "layout"),
        mobileColumns: G.select("mobileColumns", "Mobile Columns", "1", [
          { value: "1", label: "1" },
          { value: "2", label: "2" },
        ], "layout"),
        productCount: G.select("productCount", "Products Per Page", "12", [
          { value: "4", label: "4" },
          { value: "8", label: "8" },
          { value: "12", label: "12" },
          { value: "16", label: "16" },
        ...
        showFilters: G.toggle("showFilters", "Show Category Filters", "false"),
        showSort: G.toggle("showSort", "Show Sort Options", "false"),
        showPagination: G.toggle("showPagination", "Show Pagination", "true"),
        showLoadMore: G.toggle("showLoadMore", "Show Load More", "false"),
        allowRowsPerPage: G.toggle("allowRowsPerPage", "Rows Per Page", "false"),
        paginationMode: G.select("paginationMode", "Pagination Mode", "pages", [
  ...
  },
  {
    ...
    props: merge(
      {
        logoUrl: G.image("logoUrl", "Logo Image"),
        storeName: G.text("storeName", "Store Name", "My Store"),
        showName: G.toggle("showName", "Show Store Name", "true"),
        layout: G.select("layout", "Header Layout", "logo-nav-icons", [{ value: "logo-nav-icons", label: "Logo | Nav | Icons" }, { value: "logo-icons-nav", label: "Logo | Icons | Nav" }, { value: "nav-logo-icons", label: "Nav | Logo | Icons" }], "layout"),
        navPosition: G.select("navPosition", "Nav Position", "center", [{ value: "left", label: "Left" }, { value: "center", label: "Center" }, { value: "right", label: "Right" }], "layout"),
        showSearch: G.toggle("showSearch", "Search Icon", "true"),
        showWishlist: G.toggle("showWishlist", "Wishlist Icon", "true"),
        showCart: G.toggle("showCart", "Cart Icon", "true"),
        showAccount: G.toggle("showAccount", "Account Icon", "true"),
        position: G.select("position", "Header Position", "sticky", [{ value: "static", label: "Static" }, { value: "sticky", label: "Sticky" }, { value: "fixed", label: "Fixed" }], "layout"),
        sticky: G.toggle("sticky", "Sticky Header (legacy)", "true"),
        transparent: G.toggle("transparent", "Transparent", "false"),
        blurBackground: G.toggle("blurBackground", "Blur Background", "false"),
        shadowOnScroll: G.toggle("shadowOnScroll", "Shadow on Scroll", "true"),
        borderBottom: G.toggle("borderBottom", "Border Bottom", "false"),
        autoHideOnScroll: G.toggle("autoHideOnScroll", "Auto Hide on Scroll", "false"),
        headerBg: G.color("headerBg", "Background", "#ffffff", "background"),
        headerHeight: G.select("headerHeight", "Desktop Height", "80", [{ value: "48", label: "48px" }, { value: "56", label: "56px" }, { value: "64", label: "64px" }, { value: "72", label: "72px" }, { value: "80", label: "80px" }], "layout"),
        tabletHeaderHeight: G.select("tabletHeaderHeight", "Tablet Height", "72", [{ value: "48", label: "48px" }, { value: "56", label: "56px" }, { value: "64", label: "64px" }, { value: "72", label: "72px" }], "layout"),
        mobileHeaderHeight: G.select("mobileHeaderHeight", "Mobile Height", "64", [{ value: "44", label: "44px" }, { value: "48", label: "48px" }, { value: "56", label: "56px" }, { value: "64", label: "64px" }], "layout"),
        logoWidth: G.select("logoWidth", "Desktop Logo Width", "40", [{ value: "24", label: "24px" }, { value: "32", label: "32px" }, { value: "40", label: "40px" }, { value: "48", label: "48px" }], "layout"),
        tabletLogoWidth: G.select("tabletLogoWidth", "Tablet Logo Width", "36", [{ value: "24", label: "24px" }, { value: "28", label: "28px" }, { value: "32", label: "32px" }, { value: "36", label: "36px" }], "layout"),
        mobileLogoWidth: G.select("mobileLogoWidth", "Mobile Logo Width", "32", [{ value: "20", label: "20px" }, { value: "24", label: "24px" }, { value: "28", label: "28px" }, { value: "32", label: "32px" }], "layout"),
        logoHeight: G.select("logoHeight", "Desktop Logo Height", "40", [{ value: "24", label: "24px" }, { value: "32", label: "32px" }, { value: "40", label: "40px" }, { value: "48", label: "48px" }], "layout"),
        tabletLogoHeight: G.select("tabletLogoHeight", "Tablet Logo Height", "36", [{ value: "24", label: "24px" }, { value: "28", label: "28px" }, { value: "32", label: "32px" }, { value: "36", label: "36px" }], "layout"),
        mobileLogoHeight: G.select("mobileLogoHeight", "Mobile Logo Height", "32", [{ value: "20", label: "20px" }, { value: "24", label: "24px" }, { value: "28", label: "28px" }, { value: "32", label: "32px" }], "layout"),
        storeNameFontSize: G.select("storeNameFontSize", "Desktop Store Name Size", "18", [{ value: "14", label: "14px" }, { value: "16", label: "16px" }, { value: "18", label: "18px" }, { value: "20", label: "20px" }], "typography"),
        tabletStoreNameFontSize: G.select("tabletStoreNameFontSize", "Tablet Store Name Size", "17", [{ value: "14", label: "14px" }, { value: "15", label: "15px" }, { value: "16", label: "16px" }, { value: "17", label: "17px" }], "typography"),
        mobileStoreNameFontSize: G.select("mobileStoreNameFontSize", "Mobile Store Name Size", "16", [{ value: "13", label: "13px" }, { value: "14", label: "14px" }, { value: "15", label: "15px" }, { value: "16", label: "16px" }], "typography"),
        logoTextGap: G.select("logoTextGap", "Desktop Logo / Name Gap", "10", [{ value: "4", label: "4px" }, { value: "8", label: "8px" }, { value: "10", label: "10px" }, { value: "12", label: "12px" }], "layout"),
        tabletLogoTextGap: G.select("tabletLogoTextGap", "Tablet Logo / Name Gap", "8", [{ value: "4", label: "4px" }, { value: "6", label: "6px" }, { value: "8", label: "8px" }, { value: "10", label: "10px" }], "layout"),
        mobileLogoTextGap: G.select("mobileLogoTextGap", "Mobile Logo / Name Gap", "8", [{ value: "4", label: "4px" }, { value: "6", label: "6px" }, { value: "8", label: "8px" }, { value: "10", label: "10px" }], "layout"),
        menuGap: G.select("menuGap", "Desktop Menu Gap", "32", [{ value: "16", label: "16px" }, { value: "24", label: "24px" }, { value: "32", label: "32px" }, { value: "40", label: "40px" }], "layout"),
        tabletMenuGap: G.select("tabletMenuGap", "Tablet Menu Gap", "24", [{ value: "12", label: "12px" }, { value: "16", label: "16px" }, { value: "20", label: "20px" }, { value: "24", label: "24px" }], "layout"),
        mobileMenuGap: G.select("mobileMenuGap", "Mobile Menu Gap", "16", [{ value: "8", label: "8px" }, { value: "12", label: "12px" }, { value: "16", label: "16px" }, { value: "20", label: "20px" }], "layout"),
        containerWidth: G.select("containerWidth", "Desktop Container Width", "1440px", [{ value: "100%", label: "Full Width" }, { value: "1200px", label: "1200px" }, { value: "1280px", label: "1280px" }, { value: "1440px", label: "1440px" }], "layout"),
        tabletContainerWidth: G.select("tabletContainerWidth", "Tablet Container Width", "100%", [{ value: "100%", label: "Full Width" }, { value: "960px", label: "960px" }, { value: "1024px", label: "1024px" }], "layout"),
        mobileContainerWidth: G.select("mobileContainerWidth", "Mobile Container Width", "100%", [{ value: "100%", label: "Full Width" }, { value: "425px", label: "425px" }, { value: "390px", label: "390px" }], "layout"),
        navFontSize: G.select("navFontSize", "Desktop Nav Font", "16", [{ value: "14", label: "14px" }, { value: "15", label: "15px" }, { value: "16", label: "16px" }, { value: "18", label: "18px" }], "typography"),
        tabletNavFontSize: G.select("tabletNavFontSize", "Tablet Nav Font", "15", [{ value: "13", label: "13px" }, { value: "14", label: "14px" }, { value: "15", label: "15px" }, { value: "16", label: "16px" }], "typography"),
        mobileNavFontSize: G.select("mobileNavFontSize", "Mobile Nav Font", "15", [{ value: "12", label: "12px" }, { value: "13", label: "13px" }, { value: "14", label: "14px" }, { value: "15", label: "15px" }], "typography"),
        iconSize: G.select("iconSize", "Desktop Icon Size", "24", [{ value: "18", label: "18px" }, { value: "20", label: "20px" }, { value: "22", label: "22px" }, { value: "24", label: "24px" }], "layout"),
        tabletIconSize: G.select("tabletIconSize", "Tablet Icon Size", "22", [{ value: "18", label: "18px" }, { value: "20", label: "20px" }, { value: "22", label: "22px" }, { value: "24", label: "24px" }], "layout"),
        mobileIconSize: G.select("mobileIconSize", "Mobile Icon Size", "20", [{ value: "16", label: "16px" }, { value: "18", label: "18px" }, { value: "20", label: "20px" }, { value: "22", label: "22px" }], "layout"),
      },
      layout, typography,
    ),
  },
  ...
  // ════════ FOOTER ════════
  {
    type: "simple-footer", label: "Simple Footer", category: "footer", icon: "Minimize", description: "Minimal footer — content from Branding & Contact CMS",
    props: merge(
      { showSocial: G.toggle("showSocial", "Show Social Icons", "true"), bgColor: G.color("bgColor", "Background", "#09090b"), textColor: G.color("textColor", "Text Color", "#fafafa", "typography"), layout: G.select("layout", "Layout", "centered", [{ value: "centered", label: "Centered" }, { value: "split", label: "Split" }], "layout") },
      layout, typography,
    ),
  },
  {
    type: "ecommerce-footer", label: "Ecommerce Footer", category: "footer", icon: "ShoppingBag", description: "Full ecommerce footer — content from global store data",
    props: merge(
      { showSocial: G.toggle("showSocial", "Show Social", "true"), showNewsletter: G.toggle("showNewsletter", "Show Newsletter", "true"), showPaymentIcons: G.toggle("showPaymentIcons", "Show Payment Icons", "true"), bgColor: G.color("bgColor", "Background", "#09090b"), textColor: G.color("textColor", "Text Color", "#fafafa", "typography"), columns: G.select("columns", "Columns", "4", [{ value: "3", label: "3" }, { value: "4", label: "4" }, { value: "5", label: "5" }], "layout") },
      layout, typography,
    ),
  },
  {
    type: "mega-footer", label: "Mega Footer", category: "footer", icon: "Layout", description: "Large footer — links from Navigation CMS",
    props: merge(
      { showBrand: G.toggle("showBrand", "Show Brand Info", "true"), showLinks: G.toggle("showLinks", "Show Link Columns", "true"), showSocial: G.toggle("showSocial", "Show Social", "true"), showNewsletter: G.toggle("showNewsletter", "Show Newsletter", "true"), showPayment: G.toggle("showPayment", "Show Payment Icons", "true"), showBadges: G.toggle("showBadges", "Show Trust Badges", "true"), bgColor: G.color("bgColor", "Background", "#09090b"), textColor: G.color("textColor", "Text Color", "#fafafa", "typography") },
      layout, typography,
    ),
  },
  {
    type: "multi-column-footer", label: "Multi Column Footer", category: "footer", icon: "Columns2", description: "Multi-column footer — links from Navigation CMS",
    props: merge(
      { columnCount: G.select("columnCount", "Column Count", "4", [{ value: "2", label: "2" }, { value: "3", label: "3" }, { value: "4", label: "4" }], "layout"), showSocial: G.toggle("showSocial", "Show Social", "true"), bgColor: G.color("bgColor", "Background", "#09090b"), textColor: G.color("textColor", "Text Color", "#fafafa", "typography") },
      layout, typography,
    ),
  },
  {
    type: "footer-links", label: "Footer Links", category: "footer", icon: "Link", description: "Link columns from Footer Navigation menu",
    props: merge(
      { title: G.text("title", "Section Title", "Quick Links"), columns: G.select("columns", "Columns", "3", [{ value: "1", label: "1" }, { value: "2", label: "2" }, { value: "3", label: "3" }, { value: "4", label: "4" }], "layout"), linkColor: G.color("linkColor", "Link Color", "#71717a", "typography"), headingColor: G.color("headingColor", "Heading Color", "#18181b", "typography") },
      layout, typography,
    ),
  },
  {
    type: "footer-social", label: "Footer Social", category: "footer", icon: "Share2", description: "Social icons from Contact CMS",
    props: merge(
      { label: G.text("label", "Section Label", "Follow Us"), iconColor: G.color("iconColor", "Icon Color", "#71717a", "typography"), hoverColor: G.color("hoverColor", "Hover Color", "#2563eb", "typography"), iconSize: G.number("iconSize", "Icon Size", "18", "layout"), headingColor: G.color("headingColor", "Heading Color", "#18181b", "typography") },
      layout, typography,
    ),
  },
  {
    type: "footer-copyright", label: "Footer Copyright", category: "footer", icon: "Copyright", description: "Copyright bar — text auto-generated from store branding",
    props: merge(
      { textColor: G.color("textColor", "Text Color", "#a1a1aa", "typography"), fontSize: G.number("fontSize", "Font Size", "12", "typography"), alignment: G.select("alignment", "Alignment", "center", [{ value: "left", label: "Left" }, { value: "center", label: "Center" }, { value: "right", label: "Right" }], "layout") },
      layout, typography,
    ),
  },
  {
